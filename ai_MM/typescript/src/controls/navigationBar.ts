...
class NavigationBar extends Control {
    ...
    private _shrinked: boolean;
    private _fullSize: number;
    private _customDocks: AnyDict;
    private _navDock: HTMLDivElement;
    private _undoBtn: HTMLDivElement;
    navContainer: HTMLDivElement;
    actionChange: procedure;
    layoutChanged: procedure;
    ...
    */
    ...
    addUndoButton() {
        ...
        let undoBtnCls = this._undoBtn.controlClass as AnyDict;
    ...
    addNavButton(viewData, caption, tooltip, asButton, isLast) {
        let btn = document.createElement('div') as any;
        if (asButton) {
