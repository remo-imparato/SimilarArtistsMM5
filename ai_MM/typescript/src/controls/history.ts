...
export default class NavigationHistory {    
    _historyItems: ViewData[];
    private _historyAddTimer: any;
    _currentPos: number;
    private _disabled: boolean;
    private _restored: boolean;
    private _mainTabContent: any;
    ADD_TO_TIMEOUT: number;
    KEEP_CACHE_TIMEOUT: number;
    ...
    raiseEvent(eventName, details, isCancelable?:boolean) {
    ...
    updateNavigation(viewData: ViewData) {
    ...
    registerNodeDelete(viewData: ViewData) {
        let _this = this;
    ...
    add(viewData, doMoveToNewPosition?:boolean) {
    ...
    _cleanCacheForView(viewData: ViewData) {
    ...
    moveToPosition(pos, noAnimations?:boolean) {
    ...
    createViewData(params: AnyDict) {
        return this._mainTabContent.createViewData(params);
    }

    applyViewData(viewData: ViewData, noAnimations?:boolean) {

        if (viewData.stored) {
            this.disabled = true;
            this._mainTabContent.restoreViewData(viewData).then(
                function (viewData) {
    ...
    set mainTabContent(value: MainTabContent) {
        this._mainTabContent = value;
    }
    get mainTabContent() : MainTabContent {
