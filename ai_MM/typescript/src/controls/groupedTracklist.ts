...
export default class GroupedTrackList extends ColumnTrackList {
    ...
    private _disableAlbumTracksLimit: boolean;
    private _completeRestore: boolean;
    private _colWidths: any[];
    _initialized: boolean;
    groupFn: AnyDict;
    useDefaultSort: string;
    private _groupTemplate: any;
    private _groupHeaderDef: any[];
    private _groupFieldDefs: any[];
    private _lastGroup: AnyDict;
    private _summaryColumns: any;
    ...
    private _currentGroupIDFocused(_currentGroupIDFocused: any) {
        ...
        if (state.allColumns && state.allColumns.forEach) {
            state.allColumns.forEach(function (col) {
                ...
                if (columnType) {
                    ...
                    if (!this._completeRestore) {
                        this._colWidths['_' + columnType] = { // add _ as a prefix in case columnType is 'length' ... we cannot store object to property named 'length'
