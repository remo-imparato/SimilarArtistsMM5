...
export default class PlaylistHeader extends Control {
    ...
    private _showJustTitle: boolean;
    private _playlistChange: any;
    private _thumbLoadPromise: any;
    QueryData: QueryData;
    QDPromise: Promise<void>;
    tracksPromise: Promise<void>;
    onQueryDataChange: () => void;
    private _origQueryData: string;
