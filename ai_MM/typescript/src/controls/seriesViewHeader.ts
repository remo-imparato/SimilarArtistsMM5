...
class SeriesViewHeader extends ViewHeader {
    ...
    private _triedTVDBImage: boolean;
    private _triedWikiImage: boolean;
    private _triedDownloadImage: boolean;
    ...
    renameSeries(newTitle: string, setTitleText?:boolean) {
    ...
    fillDescriptionElement(wikiText, params) {
        ...
        let prepareElement = function () {
            let wikiDesc = document.createElement('span') as ElementWith<Editable>;
