...
export default class ArtistAlbums extends Control {
    private _scrollingParent: HTMLElement;
    showingOtherAlbums: boolean;
    isSomeOtherAlbum: boolean;
    private _promises: AnyDict;
    onlineEventsSet: boolean;
    private _onlineDataParsed: boolean;
    showingOnline: boolean;
    myMusicSet: boolean;
    private _ds: any; // todo
    UI: { [key: string]: HTMLElement; };
    wasError: boolean;
    foundArtists: any;
    fillAlbumsPromises: Promise<unknown>[];
    private _dataSourceChangeHandler: (...params: any[]) => void;
    private _commonChange: procedure;
    
    initialize(rootelem: HTMLElement, params?: AnyDict) {
    ...
    clearArtistData(clearAll?:boolean /* if true, clear also foundArtists, we are changing whole data source */ ) {
...
let mbListDefs = [{
    ...
    primaryType: 'Album',
    noSecondaryType: true, // include only Albums without secondary type
