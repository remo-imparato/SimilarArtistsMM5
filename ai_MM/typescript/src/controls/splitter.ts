...
class Splitter extends Control {
    ...
    _wasvisible: boolean;
    _resized: boolean;
    _siblingsVisibilityChanged: boolean;
    sortSiblingsByOrder: boolean;
    isVertical: boolean;
    lastWindowState: any;
    private _layoutChangedHandler: any;
    private _mouseUpHandler: any;
    private _mouseDownHandler: any;
    private _siblings: any;
    private _spIdx: number;
    ...
    initialize(rootelem, params) {
        ...
        this.localListen(thisWindow, 'visibilitychanged', function (min, vis, state, restoring) { // state: 0 normal, 1 minimized, 2 maximized
