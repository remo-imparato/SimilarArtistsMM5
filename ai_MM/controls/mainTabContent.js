...
export default class MainTabContent extends Control {
    initialize(rootelem, params) {
        ...
        app.listen(this.mediatree, 'focuschange', function () {
        ...
        this.loadAsync = function () {
            _this.loadingPromise = new Promise(function (resolve, reject) {
                whenReady(function () {
    ...
    createViewData(params) {
        ...
        return {
            ...
            clickedRect: params.clickedRect,
            dataSourceCache: {},
    ...
    restoreViewData(viewData) {
        return new Promise(function (resolve, reject) {
            ...
            tree.setNodePath(viewData.treePath, null, true /* no focus event */).then(function () {
                if (!this._cleanUpCalled) {
                    ...
                    nodeUtils.getNodeByPath(this.rootNode, viewData.nodePathSources).then(function (foundNode) {
