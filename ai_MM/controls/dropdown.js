...
export default class Dropdown extends Control {
    ...
    */
        ...
        this.localListen(this.edit, 'keydown', (e) => { this.editboxKeyDown(e); });
        this.localListen(this.edit, 'keyup', (e) => { this.editboxKeyUp(e); });
        this.localListen(this.edit, 'focus', (e) => { this.editboxFocus(e); });
        this.localListen(this.edit, 'blur', (e) => { this.editboxBlur(e); });
        ...
        this.localListen(this.select, 'mousedown', (e) => { this.selectClick(e); });
        this.localListen(this.select, 'mouseup', (e) => { this._catchEvent(e); }); // stop propagation this event, to avoid losing focus e.g. when in LV
        this.localListen(this.edit, 'mousedown', (e) => {
            if (this.readOnly)
                this.selectClick(e);
            else
                this._focusInList = false;
        });
        this.localListen(this.edit, 'mouseup', (e) => { this._catchEvent(e); }); // stop propagation this event, to avoid losing focus e.g. when in LV
    ...
    handleDSModify(newIndex, oldIndex) {
...
class DropdownHandler {
    constructor(params) {
        ...
        this.mouseupDropdown = function (evt) {
        ...
        this.resizeDropdownWindow = function (evt) {
            if (!this.window)
                return;
    ...
    handleKeypressed(key, shiftKey, ctrlKey, altKey, metaKey) {
        ...
        /**
            ...
            @event keydown
        */
        let evt = createNewEvent('keydown');
        evt.key = key;
    ...
    initDropdown(params) {
        ...
        else if (this.dbProp && (app.db[this.dbProp] !== undefined)) {
