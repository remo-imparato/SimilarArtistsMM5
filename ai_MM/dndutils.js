...
let FT_ALL = 0, FT_BASIC = 1, FT_INCL_PLST = 2, FT_INCL_PLG = 3;
let playlist_audioExts = null, playlist_videoExts = null, fileTypes_lists = [];
...
*/
    ...
    prepareDragEventMethods: function (e) {
...
@return {boolean} result
*/
    isAllowedType: function (e, datatype) {
            ...
            if (this.droppingFileNames(e)) {
                ...
                let browseList = function (list) {
                    ...
                    for (let i = 0; i < size; i++) {
                        ...
                        else if ((typeof item === 'string') && (allowed.indexOf(item.toLowerCase()) >= 0)) { // probably image from web page
                            item = {
                                type: item,
                                kind: 'file'
                            };
...
*/
    getDragObject: function (e, datatype) {
        if (this.isDragEvent(e)) {
            if (this.droppingFileNames(e)) {
                let allowed = getAllowedFiles(datatype);
...
*/
    player_handleDrop: function (e, index, clear, startPlayback) {
        _isAllowed = -1;
...
*/
    listview_player_handleDrop: function (e, lv) {
...
@param {object} Drag&Drop event object
*/
    listview_handleReordering: function (e) {
...
@param {object} Drag&Drop event object
*/
    getFocusedItemHandler: function (e) {
        let result = false;
        let nodeIndex = -1;
...
*/
    ...
    handleDroppedCover: function (e, dropCB, div) {
