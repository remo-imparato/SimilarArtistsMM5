...
let animTools = {
    ...
    */
    getVisibilityAnimation: function (element, visible) {
        ...
        else if (element.hasAttribute('data-animate-width')) {
            animateWidth();
            animateOpacity = true;
        }
        else if (element.classList.contains('hoverHeader') || element.classList.contains('toolbutton') || element.classList.contains('tooltip')) {
            retval.push('opacity');
        }
        else if (parentNode) {
    ...
    animateAddRow: function (row, onComplete) {
    ...
    animateRemoveRow: function (row, onComplete) {
        row.style.minHeight = '0';
    ...
    animateShowRow: function (row, onComplete) {
    ...
    animateHideRow: function (row, onComplete) {
        let origMinHeight = row.style.minHeight;
        let origHeight = row.clientHeight;
        row.style.minHeight = 0;
        row.classList.add('noOverflow');
