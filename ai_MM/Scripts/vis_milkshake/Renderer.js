...
var Renderer = Class.extend({
    ...
    Interpolation: function (pipeline) {
        gl.bindTexture(gl.TEXTURE_2D, this.renderTarget.textureID[1]); // probably temporary hack, there was textureID[0], but this texture is used for frame buffer and does not work as it should.
...
var RenderTarget = Class.extend({
    init: function (texsize, width, height) {
        console.log("RenderTarget init begin");
        var mindim = 0;
        var origtexsize = 0;
        this.texsize = texsize;
        ...
        console.log("RenderTarget init end");
