...
class SearchView extends Control {
    ...
    _createHandlerHeader(handler) {
        ...
        let res = '<div data-id="' + handler.key + 'Header" data-result-header class="padding ' + headerClass + '">' +
    ...
    _initLoading(control, dataSource, header, expander, version) {
        ...
        let _setResVisibility = function (vis, reinit) {
            if (reinit || isVisible(control, false) != vis) {
                ...
                if (_this.scrollingParent)
                    idleNotifyLayoutChangeDown(_this.scrollingParent); // Notify all children of our parent scrolling element
            }
        };
