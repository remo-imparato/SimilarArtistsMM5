...
let getLVItem = function (div, item?, idx?:number) {
...
(function () {
    ...
    window.templates = {
        ...
        groupedTracklistByAlbum: function (div, params) {
            ...
            let coverContainer = document.createElement('div') as CustomElement;
        ...
        groupedTracklistByAlbumHeaders: [
            {
                ...
                onGroupDivInit: function (div, column) {
                    if (column.width) {
                        ...
                        if (div.artworkDiv) div.artworkDiv.style.height = initWidth;
                        if (div.noaa) div.noaa.style.height = initWidth;
                ...
                onColumnResize: function (div) {
                    ...
                    this.groupDivs.forEach((groupDiv) => {
                        ...
                        if (groupDiv.artworkDiv) groupDiv.artworkDiv.style.height = newHeight;
                        if (groupDiv.noaa) groupDiv.noaa.style.height = newHeight;
                    });
                    if (this.dataSource) {
        ...
        */
            ...
            if (allowed) {
                ...
                if ((!useHandler) || ((useHandler.value !== text) || (!useHandler.element))) {
                    ...
                    let addListen = function (span) {
                        ...
                        span.controlClass.localListen(span, 'mouseup', (e) => { if ((e.which === 1 /* left button */)) e.stopPropagation(); });
                    };
                    ...
                    values.forEach(function (value, idx) {
                        ...
                        let span = document.createElement('span') as CustomElement;
        ...
        lyricsFunc: function (div, item, el, params) {            
            ...
            let startLyricsSearching = function (force?:boolean) {
        ...
        ratingEditableFunc: function (div, item, el, params) {
            ...
            let itm = item;
            if (itm.objectType === 'playlistentry') itm = itm.sd;
            let ival = itm.rating;
            if (!el.controlClass) {
        ...
        assignHTMLifDifferent: function (el, txt) { // used to avoid unwanted replacements, which can suppress clicks, #19033
            if (el.innerHTML !== txt)
                el.innerHTML = txt;
        },
        ...
        imageItemsParams: {
            ...
            podcastNode: {
                imgBind: 'func: templates.nodeItemImageFunc(div, item, div.itemIndex);',
                noThumbIcon: 'podcast',
                line1Bind: 'func: el.textContent = nodeUtils.getNodeTitle(item)', // getNodeTitle needed here, because there can be the "Loading..." node for a while
        ...
        */
        ...
        findLVStyleColorTypes: function () {
            if ((selectedStyle === undefined) && (document.styleSheets[0])) {
                ...
                for (let i = 0; i < classes.length; i++) {
                    let rule = classes[i] as CSSStyleRule;
            ...
            if (selectedStyle === 'color') {
                ...
                if ((clr[0] + clr[1] + clr[2]) / 3 < 128) {
                    ...
                    templates.setPopupListColors(div.controlClass.uniqueID, {
                        ...
                        select: getShiftedRGB(-50, clr),
                        hoverSelect: getShiftedRGB(-70, clr),
                        nowplaying: 'rgb(0, 0, 0)', //!important', // #17668
                        iconsHover: 'rgb(100, 75, 0)'
                    }, parentID);
                }
            }
        ...
        nodeIconFunc: function (div, item, icon) {
            ...
            if (!icon /* && div.cloned*/ ) // needs to be cleaned for cached divs too (#15516)
                cleanBasicElement(div.noaa);
            if (icon) {
