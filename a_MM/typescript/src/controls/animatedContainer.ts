...
export default class AnimatedContainer extends Control {
    mainLabel: HTMLElement;
    textDivider: HTMLLabelElement;
    labelCopy: HTMLLabelElement;
    ...
    initialize(rootelem, params) {
        ...
        this.mainLabel = this.container.children[0] as HTMLElement;
