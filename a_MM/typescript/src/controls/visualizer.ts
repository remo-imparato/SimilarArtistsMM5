...
class Visualizer extends Control {
    ...
    private _BAR1DASHHEIGHT: number;
    private _BAR1HEIGHT: any;
    private _BAR1SPACEHEIGHT: number;
    private _FALL_DUR: number;
    ...
    private _fillStyle2: string;
    private _waitforupdate: boolean;
    private _visCanvas: HTMLCanvasElement;
    private _bandcount: number;
    private _nonvisCanvas: HTMLCanvasElement;
    private _gapsize: number;
    vis: Visualization;
    lasttm: number;
    update: any;
    private _lastVisData: any;
    private _visCanvasCtx: any;
    private _nonvisCanvasCtx: any;
    onPlaybackState: (state: any) => void;
    isOurTrack: boolean;
    sd: Track;
    _isVisible: boolean;
    private _divsParent: HTMLDivElement;
