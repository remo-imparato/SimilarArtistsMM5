...
import TrackListView, { Fields } from './trackListView';
import './statusbar';
...
window.menus.chooseColumns = function (lv) {
    ...
    if (lv.controlClass.autoSortSupported && !lv.controlClass.forceDisableCustomSort)
