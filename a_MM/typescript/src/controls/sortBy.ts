...
export default class SortBy extends Control {
    ...
    initialize(elem, params) {
        ...
        let dropdownCls = UI.SortBy.controlClass as Dropdown;
    ...
    get index () {
        let idx = (this.UI.SortBy.controlClass as Dropdown).focusedIndex;
        if (idx < 0)
            idx = 0;
        return idx;
    }
    ...
    */    
    ...
    set id (value) {
        ...
        (this.UI.SortBy.controlClass as Dropdown).focusedIndex = idx;
    }
