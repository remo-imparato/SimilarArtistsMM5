...
export type Fields = (string|FieldGroup)[];
...
export const tracklistFieldDefs = {
    ...
    extendedTags: {
        ...
        bindData: function (div, item) {
            ...
            let tipTxt : string = getSimplifiedExtendedTags(txt, '\n');
            if (tipTxt) {
    ...
    organizedPath: {
        ...
        width: 400,
        noExport: true, // do not use in exporting        
        notForAlbum: true, // this field should not be used for whole album, specific for each track
    },
    fileType: {
        title: _('Extension'), // #18335
        disabled: false,
        checked: false,
        bindData: function (div, item) {
                        ...
                        action: {
                            ...
                            execute: function () {
                                ...
                                searchTools.searchAAImageDlg(origItem, function () {
                                    ...
                                    showApply2Album: true,  // @ts-ignore
...
export default class TrackListView extends GridView {
    ...
    private _sortedEvent: any;
    private _fieldGroups: any;
