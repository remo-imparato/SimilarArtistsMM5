...
export default class PlaylistEditor extends Control {
    ...
    initialize(rootelem, params) {
        ...
        (this.tracklist.controlClass as ListView).showHeader = false;
    ...
    startEditTitle() {
        (this.title.controlClass as Editable).contenteditable = true;
        this.title.focus();
    ...
    updateData() {
        if (this.playlist)
            (this.title.controlClass as Editable).text = this.playlist.name;
    }
